            ...
            @if (session('claim_data'))
                <div class="success-details">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            ...
                            @elseif (session('claim_data')['urgency'] == 'medium')
                                <span class="badge bg-warning text-dark py-1.5 px-3 rounded-pill">ปานกลาง (Medium)</span>
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value" style="white-space: pre-line;">{{ session('claim_data')['defect_description'] }}</div>
                    </div>
                </div>
            @endif
        </div>
        ...
        <form method="POST" action="{{ route('claim.submit') }}">
            ...
            <div class="mb-4">
                ...
                <input 
                    ...
                    placeholder="กรอกรหัสตัวอักษรและตัวเลข เช่น SN987654"
                    autocomplete="off"
                >
                @error('serial_number')
            ...
            <div class="mb-4">
                ...
                <textarea 
                    ...
                    placeholder="อธิบายอาการชำรุด ความเสียหาย หรือความผิดปกติที่เกิดขึ้นของสินค้า (เช่น เปิดเครื่องไม่ติด หน้าจอแตก ไฟไม่เข้า)"
                >{{ old('defect_description') }}</textarea>
